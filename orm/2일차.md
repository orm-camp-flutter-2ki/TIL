...
### 라이브러리와 프레임워크의 차이
라이브러리는 개발자가 필요한 기능을 가져와 사용할 수 있는 도구의 모음  
프레임워크는 개발자에게 구조와 규칙을 제공하여 애플리케이션을 개발할 수 있는 플랫폼  
둘 다 재사용 가능한 코드와 기능의 집합이지만, 프레임워크만의 특징은 어떤 목적(어플리케이션의 개발 등)을 이루기 위해 개발자에게 제공되는 뼈대라는 점이다.
